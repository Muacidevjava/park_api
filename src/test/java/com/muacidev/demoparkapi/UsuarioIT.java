package com.muacidev.demoparkapi;
...
public class UsuarioIT {
    ...
    @Test
    public void createUsuario_ComUsernameValidos_RetornarErroMessageStatus422(){
    ...
    @Test
    public void createUsuario_ComPasswordInValidos_RetornarErroMessageStatus422(){
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioCriadoComStatus200(){
        ...
        UsuarioResponseDto responseBody = testClient
                ...
                .headers(JwtAuthetication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDto.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                .get()
                .uri("/api/v1/usuarios/101")
                .headers(JwtAuthetication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDto.class)
                .returnResult().getResponseBody();
